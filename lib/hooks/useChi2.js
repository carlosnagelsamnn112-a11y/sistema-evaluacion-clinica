...
export default function useChi2() {
  ...
  const calcularPruebaChi2 = useCallback((pacientes, exploraciones, historias, analisis) => {
    ...
    const getEtiquetaFila = (cat) => {
      ...
      if (varFila === 'Lesiones en los labios (Sí / No)') return cat === 'Sí' ? 'Con lesión labial' : 'Sin lesión labial' // Nota: mantenido igual a la lógica del original en getEtiquetaFila
